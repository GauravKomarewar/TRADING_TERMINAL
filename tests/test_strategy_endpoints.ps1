...
$configDir = Join-Path $PSScriptRoot "..\shoonya_platform\strategies\saved_configs"
...
$dashPassword = if ($env:DASHBOARD_PASSWORD) { $env:DASHBOARD_PASSWORD } else { "<set DASHBOARD_PASSWORD env var>" }
Write-Host "   URL: http://localhost:8000/" -ForegroundColor Gray
Write-Host "   Password: $dashPassword" -ForegroundColor Gray
...
Write-Host "   b) Enter password: $dashPassword" -ForegroundColor Gray
