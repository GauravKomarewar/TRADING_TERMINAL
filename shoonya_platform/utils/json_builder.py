...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("🎯 EXAMPLE 1: SHORT STRADDLE ENTRY")
    print("=" * 80)
    
    straddle_entry = build_straddle(
    ...
    print(json.dumps(straddle_entry, indent=2))
    
    print("\n" + "=" * 80)
    print("🎯 EXAMPLE 2: SHORT STRADDLE EXIT")
    print("=" * 80)
    
    straddle_exit = build_straddle(
        secret_key="GK_TRADINGVIEW_BOT_2408",
        execution_type="exit",
        strategy_name="short_straddle",
        underlying="NIFTY",
        ...
        atm_strike=24500,
        qty=75,
        direction="SELL"  # Same as entry; will auto-reverse
    )
    
    print(json.dumps(straddle_exit, indent=2))
    
    print("\n" + "=" * 80)
    print("🎯 EXAMPLE 3: CUSTOM MULTI-LEG STRATEGY")
    print("=" * 80)
    
    # Build custom legs
    custom_legs = [
        build_leg(
            tradingsymbol="NIFTY23DEC25C24600",
            direction="SELL",
            qty=75
        ),
        build_leg(
            tradingsymbol="NIFTY23DEC25P24400",
            direction="SELL",
            qty=75
        ),
        build_leg(
            tradingsymbol="NIFTY23DEC25C24700",
            direction="BUY",
            qty=75
        ),
        build_leg(
            tradingsymbol="NIFTY23DEC25P24300",
            direction="BUY",
            qty=75
        )
    ]
    
    custom_strategy = build_strategy_json(
        secret_key="GK_TRADINGVIEW_BOT_2408",
        execution_type="entry",
        strategy_name="custom_iron_condor",
        exchange="NFO",
        underlying="NIFTY",
        expiry="23DEC25",
        product_type="M",
    ...
    print(json.dumps(custom_strategy, indent=2))
    
    print("\n" + "=" * 80)
    print("🎯 EXAMPLE 4: VALIDATION")
    print("=" * 80)
    
    is_valid, message = validate_json(straddle_entry)
