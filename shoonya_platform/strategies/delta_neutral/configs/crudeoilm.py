"""
MCX CRUDEOIL - Delta Neutral Auto Adjust Short Strangle
CONFIG ONLY
"""
...
CONFIG = StrategyConfig(
    ...
    exit_time=time(23, 15),         # Exit before MCX close (23:30)

    # Delta parameters (CRUDEOILM is more volatile than NIFTY)
