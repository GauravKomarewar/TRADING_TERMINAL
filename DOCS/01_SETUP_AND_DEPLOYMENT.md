...
```bash
# Edit paths if your user is not ec2-user
sudo nano deployment/trading.service
# Change: User=ubuntu, Group=ubuntu
# Change: WorkingDirectory=/home/ubuntu/shoonya_platform
# Change: ExecStart=/home/ubuntu/shoonya_platform/venv/bin/python /home/ubuntu/shoonya_platform/main.py
...
|-------|----------|--------|
| `trading_start.timer` | Mon–Fri 08:45 AM | Starts `trading.service` |
| `trading_stop.timer` | Daily 12:00 AM (midnight) | Stops `trading.service` |
